...
#include <cinttypes>
#include <iostream>
//there is only linked list question, implementation of the maze solver project is in the Maze_with_wrapper folder
using namespace std;
